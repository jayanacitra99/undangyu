...
class UpdateEventTypeRequest extends FormRequest
{
    public function authorize(): bool
    {
        ...
        return $eventType !== null && ($this->user()?->can('update', $eventType) ?? false);
    }
    ...
    public function rules(): array
    {
        return [
            ...
            'slug' => ['required', 'string', 'max:80', 'alpha_dash', Rule::unique('event_types', 'slug')->ignore($this->route('event_type'))],
